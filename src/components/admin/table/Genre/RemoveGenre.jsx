...
import { handleCreateGenre, handleRemoveGenre, handleUpdateGenre } from '../../../../services/Genres';
import { Hidden } from '@mui/material';


const RemoveGenre = ({onCall,id,name}) => {
    ...
    const handleOk = async () => {
        if (Cookies.get('token')) {
            //const created = await handleCreatePlaylist(name, date_create, song)
             const update = await handleRemoveGenre(id);
             console.log(update);
    ...
    return (
        <>
            ...
            <Modal
                ...
                <ModalHeader>
                    <a style={{color:"white",fontSize:'30px'}}>Delete genre</a>
