        ...
        <>
            {type == "artists" ?
                <div className="featured">
                    <a className="more" style={{color:"white",fontSize:'20px'}}  onClick={() => { navigate('artists') }} >See more...</a>
                ...
                :
                <div className="featured">
                    <a className="more" style={{color:"white",fontSize:'20px'}} onClick={() => { navigate('albums') }}  >See more...</a>
                    <div className='wrapper-album' >
                        {list?.map((album, index) => (
                            <div key={index}>
                                ...
                                <a style={{color:"white"}}className='artist-name'> {album?.name} </a>
                            </div>
                        ))}
